...
const ALL_KEYS = [
  ...
  'app.logout',
  'app.managingTournamentMessage',
  'app.matchManagement',
  'app.selectedTournament',
  'app.teamParticipantManagement',
  'app.title',
  'app.tournamentCreatedMessage',
  'app.tournamentSelectedMessage',
  'auth.login.adminCreateButton',
  'auth.login.adminCreateSection',
  'auth.login.adminCreatedSuccess',
  'auth.login.adminTab',
  ...
  'matchList.statusLabel',
  'matchList.summary',
  'matchList.title',
  'matchList.totalMatches',
  ...
  'participantManagement.titleForTeam',
  'resultEntry.actions',
  'resultEntry.add',
  ...
  'resultEntry.win',
  'teamDashboard.historyButton',
  'teamDashboard.historySectionDescription',
  'teamDashboard.historySectionTitle',
  'teamDashboard.loadDashboardFailed',
  ...
  'teamDashboard.manageParticipantsButton',
  'teamDashboard.matchManagementAdminButton',
  'teamDashboard.matchManagementAdminDescription',
  'teamDashboard.matchManagementAdminTitle',
  'teamDashboard.matchManagementViewerButton',
  'teamDashboard.matchManagementViewerDescription',
  'teamDashboard.matchManagementViewerTitle',
  'teamDashboard.membersDescription',
  'teamDashboard.membersSection',
  'teamDashboard.participantsCountLabel',
  'teamDashboard.retry',
  'teamDashboard.signOut',
  'teamDashboard.subtitle',
  'teamDashboard.title',
  'teamDashboard.todayMatchesLabel',
  'teamDashboard.todayRecordEmpty',
  'teamDashboard.todayRecordValue',
  'teamDashboard.todaySummaryTitle',
  'teamLoginForm.backToAdminLogin',
  'teamLoginForm.loginButton',
  'teamLoginForm.loginFailed',
  'teamLoginForm.password',
  'teamLoginForm.title',
  'teamLoginForm.tournamentCodeLabel',
  'teamLoginForm.username',
